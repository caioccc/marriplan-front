...
const LeafletMapComponent: React.FC<LeafletMapProps> = ({ mapPosition, setMapPosition, reverseGeocode, form, L }) => {
  ...
  return (
    <div style={{ height: 260, width: '100%', marginBottom: 16, marginTop: 16, borderRadius: 8, overflow: 'hidden' }}>
      <LeafletMap center={mapPosition || [-14.235, -51.9253]} zoom={mapPosition ? 16 : 4} style={{ height: '100%', width: '100%' }} scrollWheelZoom={true}>
