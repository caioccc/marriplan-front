...
export default function TermsPage() {
  return (
    <>
      <Head>
        <title>Termos de Uso | Marriplan</title>
        <meta
          name="description"
          content="Consulte os Termos de Uso do Marriplan em uma página pública, clara e responsiva, com conteúdo organizado por seções."
        />
        <link rel="canonical" href="https://marriplan.com/terms" />
        <meta property="og:title" content="Termos de Uso | Marriplan" />
        <meta
          property="og:description"
          content="Consulte os Termos de Uso do Marriplan em uma página pública, clara e responsiva, com conteúdo organizado por seções."
        />
        <meta property="og:url" content="https://marriplan.com/terms" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Termos de Uso | Marriplan" />
        <meta
                ...
                <Stack gap="lg">
                  <Group gap="sm" wrap="wrap">
                    ...
                    <Text size="sm" c="var(--marriplan-muted)">
                      Última atualização: {termsLastUpdated}
                    </Text>
                  </Group>
