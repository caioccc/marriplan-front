...
const inputStyles = {
  input: { borderColor: PALETTE.line, focusBorderColor: PALETTE.roseGold },
};
...
const WeddingCostSimulationResultPage: NextPage = () => {
        ...
        if (token) {
          ...
          if (res.ok) {
            ...
            notifications.show({
              color: "red",
              title: "Erro",
              message: "Simulação compartilhada expirada ou inválida.",
            });
          }
        } else if (!authLoading) {
          ...
          >
            ...
            >
              ...
              <Text
                ...
                mx="auto"
              >
                Utilize nossa consultoria inteligente para estimar
                detalhadamente os custos e prazos do casamento dos seus sonhos.
              </Text>
              <Button
                color="var(--marriplan-rose)"
                radius="xl"
  ...
  const shareToken =
    user?.wedding_profile?.simulation_share_token || token || "demo-token";
  ...
  const barChartData = [
    ...
    {
      cenario: "Luxo/Sonho",
      valor: scenarios.alternativePremium.totalEstimated,
    },
  ];
  ...
  return (
    <BaseLayout>
      <Container size="lg" py="xl">
        ...
        >
          ...
          >
            ...
            <Text
              ...
              mt="sm"
            >
              Baseado nas especificações técnicas fornecidas, volume de
              fornecedores e localização logística do evento.
            </Text>

            {simulationData.generatedAt && (
              <Text size="xs" c="dimmed" mt="lg">
                Última atualização do motor de cálculo:{" "}
                {simulationData.generatedAt}
              </Text>
            )}
          </Card>
          ...
          {[
            {
              icon: IconUsers,
              title: "Convidados",
              desc: `${inputs.guestsCount} pessoas`,
            },
            {
              icon: IconCalendar,
              title: "Data Prevista",
              desc: inputs.weddingDate
            ...
            },
            {
              icon: IconCrown,
              title: "Categoria",
              desc: translateEventLevel(inputs.eventLevel).toUpperCase(),
            },
          ].map((item, idx) => (
            <Card
              key={idx}
            ...
            <Group gap="sm" align="flex-start" wrap="nowrap">
              ...
              <Box>
                <Text size="sm" fw={700} c={PALETTE.ink}>
                  Análise de Compatibilidade do Perfil
                </Text>
                <Text size="sm" c={PALETTE.warmGray} mt={4} lh={1.5}>
                  Seu perfil se aproxima de um casamento{" "}
                  {inputs.eventLevel === "luxury"
                    ? "exclusivo de alto padrão"
                    : "moderno e sob medida"}
                  , com foco prioritário estruturado em{" "}
                  {inputs.priorities.length > 0
                    ? inputs.priorities.join(", ")
                    : "equilíbrio global de fornecedores"}
                  . A configuração em {inputs.city} apresenta custos
                  competitivos comparados a grandes polos metropolitanos
                  nacionais.
                </Text>
              </Box>
            </Group>
          ...
          <Grid spacing="md" align="stretch">
            ...
            <Grid.Col span={{ base: 12, md: 4 }}>
              ...
              >
                ...
                <Text size="xs" c={PALETTE.warmGray} mt="xs" lh={1.4}>
                  {scenarios.alternativeEconomical.description} Ideal para quem
                  busca otimização máxima sem abrir mão da elegância essencial.
                </Text>
              </Card>
            </Grid.Col>
            ...
            <Grid.Col span={{ base: 12, md: 4 }}>
              ...
              >
                ...
                >
                  ...
                  <Text size="xs" c={PALETTE.warmGray} mt="xs" lh={1.4}>
                    {scenarios.target.description} Equilibra perfeitamente todos
                    os desejos pontuados em sua consultoria com segurança
                    orçamentária.
                  </Text>
                </Card>
              </motion.div>
            ...
            <Grid.Col span={{ base: 12, md: 4 }}>
              ...
              >
                ...
                <Text size="xs" c={PALETTE.warmGray} mt="xs" lh={1.4}>
                  {scenarios.alternativePremium.description} Entrega máxima com
                  upgrades sofisticados em gastronomia, entretenimento e
                  efeitos.
                </Text>
              </Card>
            </Grid.Col>
        ...
        <Box mt={40}>
          ...
          >
            <Title order={3} c={PALETTE.ink} mb="lg">
              Plano para alcançar esse objetivo
            </Title>
            ...
            <Grid align="center">
              <Grid.Col span={{ base: 12, md: 4 }}>
                <Center>
                  <RingProgress
                    ...
                    sections={[
                      {
                        value: monthlyGoalStatus.isPossibleBeforeWedding
                          ? 100
                          : 70,
                        color: "var(--marriplan-rose)",
                      },
              ...
              <Grid.Col span={{ base: 12, md: 8 }}>
                ...
                <Alert
                  ...
                  color={
                    monthlyGoalStatus.isPossibleBeforeWedding
                      ? "teal"
                      : "orange"
                  }
                  radius="lg"
                  mt="xl"
                >
                  Guardando aproximadamente{" "}
                  <b>{formatCurrency(inputs.monthlySaving)}</b> por mês, vocês
                  conseguem acumular o aporte planejado para cobrir as despesas
                  essenciais do cronograma.
                </Alert>
              </Grid.Col>
            </Grid>
          </Card>
        ...
        <Box mt={40}>
          <Title order={3} c={PALETTE.ink} mb="sm">
            O que descobrimos sobre o seu casamento
          </Title>
          <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
          ...
          >
            <Box mb="md">
              ...
              <Text size="xs" c={PALETTE.warmGray} mt={2}>
                Marque opções alternativas abaixo para visualizar projeções
                hipotéticas de redução de custo em tempo real, sem corromper sua
                simulação oficial.
              </Text>
            </Box>
            ...
            {totalEconomyCalculated > 0 && (
              ...
              >
                ...
                <Group justify="space-between">
                  <Text size="sm" fw={600} c={PALETTE.ink}>
                    Potencial de Economia Aplicado:
                  </Text>
                  <Title order={3} c="teal">
                    {formatCurrency(totalEconomyCalculated)}
                  </Title>
                </Group>
                <Group justify="space-between" mt={4}>
                  <Text size="sm" fw={500} c={PALETTE.warmGray}>
                    Novo Valor Estimado Otimizado:
                  </Text>
                  <Text size="lg" fw={700} c={PALETTE.ink}>
                    {formatCurrency(
                      scenarios.target.totalEstimated - totalEconomyCalculated,
                    )}
                  </Text>
                </Group>
              </motion.div>
        ...
        <Grid spacing="md" my={40}>
          <Grid.Col span={{ base: 12 }}>
            ...
            >
              <Title order={4} c={PALETTE.ink} mb="xs">
                Compartilhe sua simulação
              </Title>
              <Text size="xs" c={PALETTE.warmGray} mb="md">
                Envie este link seguro e otimizado para o seu parceiro ou
                assessoria financeira visualizarem o relatório completo.
              </Text>
              <Group gap="sm">
                <Button
                ...
                <Button
                  ...
                  style={primaryButtonStyles.root}
                >
                  Compartilhar
                </Button>
              </Group>
        ...
        <motion.div whileHover={{ y: -8 }} transition={{ duration: 0.2 }}>
          <div className="relative overflow-hidden rounded-[2.4rem] border border-[#eadfd3] bg-[linear-gradient(135deg,#2f2822_0%,#4b3f36_58%,#6a584b_100%)] px-8 py-14 shadow-[0_28px_80px_rgba(47,40,34,0.22)] sm:px-12 lg:px-16 lg:py-16">
            ...
            <Text
              ...
              mx="auto"
            >
              Transforme seus números em realidade integrando esta simulação
              diretamente ao seu cronograma e Checklist de tarefas do Marriplan.
            </Text>
