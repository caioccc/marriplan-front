          ...
          {contractUrl ? (
            <Stack gap="md">
              ...
              <Group justify="flex-end">
                <Button variant="default" styles={softButtonStyles} radius="xl" onClick={() => setContractPreviewOpen(false)}>
                  Fechar
                </Button>
                <Button styles={primaryButtonStyles} radius="xl" onClick={handleDownloadContract}>Baixar contrato</Button>
              </Group>
            </Stack>
          ) : null}
        </Modal>
